...
export default function Index(){
    ...
    return(
        <>
            <div className="relative py-5" id='inquiries'>
                ...
                <div className="relative flex justify-center text-white space-x-7">
                    <div>
                        <div className='flex items-center justify-end md:text-2xl'>
                            <BsTelephoneFill className='mr-2'/>
                            +62 813 1822 8922
                        </div>
                        <hr />
                        <h6 className='text-right md:text-xl'>TSAexport.id@gmail.com</h6>
                        <div>
                            9:00-18:00 (weekday) 
                    ...
                    <div>
                        <button className='flex items-center bg-amber-400 p-3 md:px-3 transition hover:opacity-70 active:opacity-100 duration-300 rounded-lg focus:ring focus:ring-orange-700'>
